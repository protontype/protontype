...
var Method_1 = require('../router/Method');
...
var ExpressApplication = (function () {
    ...
    function ExpressApplication() {
        ...
        this.sequelizeDB = new SequelizeDB_1.SequelizeDB(Config_1.Config.database).loadModels(SequelizeModelConfig_1.SequelizeModelConfig.modelsList);
    }
    /**
